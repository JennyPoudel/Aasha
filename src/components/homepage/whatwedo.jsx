...
function Whatwedo() {
  ...
  return (
    ...
    <div className="absolute top-[133.25rem] left-[30rem] box-border w-[34.06rem] h-[6.44rem] text-[3.38rem] text-darkslategray-100 bg-[white] ">
        ...
        <div className=" lg:w-1/2 md:w-full sm:w-full absolute top-[142.06rem] left-[5.38rem] box-border w-[71.18rem] h-[43.13rem] text-left text-[4.05rem] text-lightskyblue border-[1px] border-solid border-whitesmoke">
          <Image
          ...
          <div className="absolute top-[8.4rem] left-[42.75rem] w-[28.43rem] h-[26.25rem]">
            ...
            <button className="cursor-pointer [border:none] p-0 bg-[lightsteelblue] absolute top-[22.65rem] left-[0rem] rounded-md w-[15.15rem] h-[3.6rem]">
      ...
      <div className="absolute top-[245.84rem] left-[5.69rem] box-border w-[70.65rem] h-[43.13rem] text-left bg-white">
        ...
        <button className="cursor-pointer [border:none] p-0 bg-[lightsteelblue] absolute top-[29.65rem] left-[0rem] rounded-md w-[15.15rem] h-[3.6rem]">
            <div className="absolute top-[0.9rem] left-[2.4rem] text-[1.35rem] tracking-[0.65px] leading-[1.8rem] font-roboto text-slategray-300 text-left inline-block w-[10.35rem]">
              Browse projects
            </div>
          </button>
...
<Link href = 'Allprojects'>
        <button className="cursor-pointer [border:none] p-0 bg-[lightsteelblue] absolute top-[34.56rem] left-[3.06rem] rounded-md w-[18.23rem] h-[3.6rem]">
