...
function FooterLittleUp() {
  return (
    <div className="absolute top-[132.63rem] left-[0rem] box-border w-full h-[21.38rem] border-[1px] border-solid border-whitesmoke">
